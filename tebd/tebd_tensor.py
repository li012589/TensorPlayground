...
parser.add_argument("-Hx",type = float,default=0,help="")
parser.add_argument("-delta",type = float,default=0.001,help="")
parser.add_argument("-iters",type = int,default=1000,help="")
parser.add_argument("-cut", type = int, default=5,help="")
...
e,v = torch.eig(H.reshape(4,4),True)
E = torch.exp(e[:,0])
...
for i in range(args.iters):
    ...
    v = v.t()[:args.cut,:].reshape(args.cut,2,args.cut)
